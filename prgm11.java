 class thread implements Runnable
{
	public void run()
	{
		...
		System.out.println("State of thread1 while it called join() method on thread2 -"+prgm11.thread1.getState());
		try
		{
			Thread.sleep(200);
		}
...
public class prgm11 implements Runnable
{
	public static Thread thread1;
	public static void main(String[] args)
	{
		prgm11 obj = new prgm11();
