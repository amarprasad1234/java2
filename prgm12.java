class thread implements Runnable
{
	public void run()
	{
		...
		System.out.println("State of thread1 while it called join() method on thread2 -"+prgm12.thread1.getState());
		try
		{
			Thread.sleep(200);
		}
...
public class prgm12 implements Runnable
{
	public static Thread thread1;
	public static void main(String[] args)
	{
		prgm12 obj = new prgm12();
